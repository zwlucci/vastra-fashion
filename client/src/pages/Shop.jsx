...
import { ShopByCategorySection } from "../components/ShopByCategorySection.jsx";
...
export function Shop() {
  ...
  return (
    <div className="pb-10">
      ...
      <ShopByCategorySection className="pt-6" />

      <PageContainer as="section" className="space-y-6 pt-6">
