...
export function serializeProduct(product) {
  ...
  return {
    ...
    imageUrl: image_url,
    productMedia: (product_type === "bundle" && !custom_bundle_image_url ? [] : (product_images || [])).map((item) => ({ ...item, type: item.type || "image" })),
    productImages: (product_type === "bundle" && !custom_bundle_image_url ? [] : (product_images || [])).filter((item) => !item.type || item.type === "image"),
    ...
    customBundleImageUrl: custom_bundle_image_url || "",
    bundleComponents: (bundle_components || []).map((component) => ({
      ...component,
      id: component.id || component.componentProductId,
      componentProductId: component.componentProductId || component.id,
      name: component.name || component.componentProductName,
      componentProductName: component.componentProductName || component.name,
      imageUrl: component.imageUrl || component.primaryImage || "",
      primaryImage: component.primaryImage || component.imageUrl || "",
